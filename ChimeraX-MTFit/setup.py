...
setup(
    ...
    license="MIT",
    python_requires=">=3.9",
    package_dir={"chimerax.mtfit": "src", "chimerax.mtfit.utils": "src/utils"},
    packages=["chimerax.mtfit", "chimerax.mtfit.utils"],
    include_package_data=True,
    package_data={"chimerax.mtfit": ["bundle_info.xml", "mt_fit.py"]},
    classifiers=[
